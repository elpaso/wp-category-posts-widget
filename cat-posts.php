...
Author: James Lao
        Modified by Alessandro Pasotti: added default thumbnails, ul class and H3/4 wrapper for titles.
Version: 3.2
  ...
  $cat_posts = new WP_Query(
	...
	?>
		<li class="cat-post-item">
			<h<?php echo $heading_level; ?>><a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h<?php echo $heading_level; ?>>
            ...
            ?>
                ...
                if($instance['thumb_size']){
                    the_post_thumbnail( $instance['thumb_size'] );
                } else {
                    the_post_thumbnail( 'cat_post_thumb_size'.$this->id );
                }
                ?>
                </a>
            <?php endif; ?>
        ...
        <p>
            <label>
                ...
                <select id="<?php echo $this->get_field_id("thumb_size"); ?>" name="<?php echo $this->get_field_name("thumb_size"); ?>">
                    <option value="" <?php if('' == $instance["thumb_size"]) {echo 'selected="selected"';}; ?>>Custom (specify below)</option>
                    <option value="thumbnail"<?php if('thumbnail' == $instance["thumb_size"]) {echo 'selected="selected"';}; ?>>150x150</option>
                    <option value="medium"<?php if('medium' == $instance["thumb_size"]) {echo 'selected="selected"';}; ?>>300x300</option>
                    <option value="large"<?php if('large' == $instance["thumb_size"]) {echo 'selected="selected"';}; ?>>640x640</option>
                </select><br />
